export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	arcanine: {
		...
		evoItem: "Fire Stone",
		eggGroups: ["Field"],
		otherFormes: ["Arcanine-Delta", "Arcanine-Fantasmal"],
		formeOrder: ["Arcanine", "Arcanine-Delta", "Arcanine-Fantasmal"],
	},
	arcaninehf: {
		num: 59,
		name: "Arcanine-Fantasmal",
	...
	victreebel: {
		...
		evoItem: "Leaf Stone",
		eggGroups: ["Grass"],
		otherFormes: ["Victreebel-Fantasmal"],
		formeOrder: ["Victreebel", "Victreebel-Fantasmal"],
	},
	victreebelhf: {
		num: 71,
		name: "Victreebel-Fantasmal",
	...
	tentacruel: {
		...
		evoLevel: 30,
		eggGroups: ["Water 3"],
		otherFormes: ["Tentacruel-Delta", "Tentacruel-Fantasmal"],
		formeOrder: ["Tentacruel", "Tentacruel-Delta", "Tentacruel-Fantasmal"],
	},
	tentacruelhf: {
		num: 73,
		name: "Tentacruel-Fantasmal",
	...
	golem: {
		...
		evoType: "trade",
		eggGroups: ["Mineral"],
		otherFormes: ["Golem-Alola", "Golem-Delta", "Golem-Fantasmal"],
		formeOrder: ["Golem", "Golem-Alola", "Golem-Delta", "Golem-Fantasmal"],
	},
	golemalola: {
		num: 76,
		name: "Golem-Alola",
	...
	ponyta: {
		...
		weightkg: 30,
		color: "Yellow",
		evos: ["Rapidash-Fantasmal"],
		eggGroups: ["Field"],
		otherFormes: ["Ponyta-Galar", "Ponyta-Fantasmal"],
		formeOrder: ["Ponyta", "Ponyta-Galar", "Ponyta-Fantasmal"],
	},
	ponytagalar: {
		num: 77,
		name: "Ponyta-Galar",
	...
	rapidash: {
		...
		evoLevel: 40,
		eggGroups: ["Field"],
		otherFormes: ["Rapidash-Galar", "Rapidash-Fantasmal"],
		formeOrder: ["Rapidash", "Rapidash-Galar","Rapidash-Fantasmal"],
	},
	rapidashgalar: {
		num: 78,
		name: "Rapidash-Galar",
	...
	kabutops: {
		...
		evoLevel: 40,
		eggGroups: ["Water 1", "Water 3"],
		otherFormes: ["Kabutops-Delta", "Kabutops-Fantasmal"],
		formeOrder: ["Kabutops", "Kabutops-Delta", "Kabutops-Fantasmal"],
	},
	kabutopshf: {
		num: 141,
		name: "Kabutops-Fantasmal",
	...
	qwilfish: {
		...
		color: "Gray",
		eggGroups: ["Water 2"],
		otherFormes: ["Qwilfish-Fantasmal"],
		formeOrder: ["Qwilfish", "Qwilfish-Fantasmal"],
	},
	qwilfishhf: {
		num: 211,
		name: "Qwilfish-Fantasmal",
	...
	dustox: {
		...
		evoLevel: 10,
		eggGroups: ["Bug"],
		otherFormes: ["Dustox-Fantasmal"],
		formeOrder: ["Dustox", "Dustox-Fantasmal"],
	},
	dustoxhf: {
		num: 269,
		name: "Dustox-Fantasmal",
		baseSpecies: "Dustox",
		forme: "Fantasmal",
		types: ["Fairy", "Poison"],
	...
	masquerain: {
		...
		evoLevel: 22,
		eggGroups: ["Water 1", "Bug"],
		otherFormes: ["Masquerain-Fantasmal"],
		formeOrder: ["Masquerain", "Masquerain-Fantasmal"],
	},
	masquerainelite: {
		num: 284,
	...
	slaking: {
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Slaking-Fantasmal"],
		formeOrder: ["Slaking", "Slaking-Fantasmal"],
	},
	slakinghf: {
		num: 289,
		name: "Slaking-Fantasmal",
		baseSpecies: "Slaking",
		forme: "Fantasmal",
		types: ["Fighting", "Dark"],
	...
	dusclops: {
		...
		evos: ["Dusknoir"],
		eggGroups: ["Amorphous"],
		otherFormes: ["Dusclops-Fantasmal"],
		formeOrder: ["Dusclops", "Dusclops-Fantasmal"],
	},
	dusclopshf: {
		num: 356,
		name: "Dusclops-Fantasmal",
	...
	regirock: {
		...
		color: "Brown",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Regirock-Delta", "Regirock-Fantasmal"],
		formeOrder: ["Regirock", "Regirock-Delta", "Regirock-Fantasmal"],
	},
	regirockhf: {
		num: 377,
		name: "Regirock-Fantasmal",
	...
	regice: {
		...
		color: "Blue",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Regice-Delta", "Regice-Fantasmal"],
		formeOrder: ["Regice", "Regice-Delta", "Regice-Fantasmal"],
	},
	regicehf: {
		num: 378,
		name: "Regice-Fantasmal",
		baseSpecies: "Regice",
		types: ["Ice"],
		gender: "N",
		baseStats: {hp: 80, atk: 50, def: 100, spa: 100, spd: 200, spe: 50},
	...
	registeel: {
		...
		color: "Gray",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Registeel-Delta", "Registeel-Fantasmal"],
		formeOrder: ["Registeel", "Registeel-Delta", "Registeel-Fantasmal"],
	},
	registeelhf: {
		num: 379,
		name: "Registeel-Fantasmal",
	...
	vespiquen: {
		...
		evoLevel: 21,
		eggGroups: ["Bug"],
		otherFormes: ["Vespiquen-Fantasmal", "Vespiquen-Delta"],
		formeOrder: ["Vespiquen", "Vespiquen-Fantasmal", "Vespiquen-Delta"],
	},
	vespiquenhf: {
		num: 416,
		name: "Vespiquen-Fantasmal",
	...
	dusknoir: {
		...
		eggGroups: ["Amorphous"],
		otherFormes: ["Dusknoir-Fantasmal"],
		formeOrder: ["Dusknoir", "Dusknoir-Fantasmal"],
	},
	dusknoirhf: {
		num: 477,
		name: "Dusknoir-Fantasmal",
	...
	musharna: {
		...
		evoItem: "Moon Stone",
		eggGroups: ["Field"],
		otherFormes: ["Musharna-Fantasmal"],
		formeOrder: ["Musharna", "Musharna-Fantasmal"],
	},
	musharnahf: {
		num: 518,
		name: "Musharna-Fantasmal",
	...
	zebstrika: {
		...
		evoLevel: 27,
		eggGroups: ["Field"],
		otherFormes: ["Zebstrika-Mega", "Zebstrika-Fantasmal"],
		formeOrder: ["Zebstrika", "Zebstrika-Mega", "Zebstrika-Fantasmal"],
	},
	zebstrikamega: {
		num: 523,
		name: "Zebstrika-Mega",
	...
	gigalith: {
		...
		evoType: "trade",
		eggGroups: ["Mineral"],
		otherFormes: ["Gigalith-DB", "Gigalith-Fantasmal"],
		formeOrder: ["Gigalith", "Gigalith-DB", "Gigalith-Fantasmal"],
	},
	gigalithdb: {
		num: 526,
		name: "Gigalith-DB",
	...
	zoroark: {
		...
		evoLevel: 30,
		eggGroups: ["Field"],
		otherFormes: ["Zoroark-Mega", "Zoroark-Fantasmal"],
		formeOrder: ["Zoroark", "Zoroark-Mega", "Zoroark-Fantasmal"],
	},
	zoroarkmega: {
		num: 571,
		name: "Zoroark-Mega",
	...
	sawsbuck: {
		...
		otherFormes: ["Sawsbuck-Fantasmal"],
		formeOrder: ["Sawsbuck", "Sawsbuck-Fantasmal", "Sawsbuck-Summer", "Sawsbuck-Autumn", "Sawsbuck-Winter"],
	},
	sawsbuckhf: {
		num: 586,
		name: "Sawsbuck-Fantasmal",
	...
	haxorus: {
		...
		evoLevel: 48,
		eggGroups: ["Monster", "Dragon"],
		otherFormes: ["Haxorus-Mega", "Haxorus-Delta", "Haxorus-Fantasmal"],
		formeOrder: ["Haxorus", "Haxorus-Mega","Haxorus-Delta", "Haxorus-Fantasmal"],
	},
	haxorusmega: {
		num: 612,
		name: "Haxorus-Mega",
	...
	accelgor: {
		...
		eggGroups: ["Bug"],
		otherFormes: ["Accelgor-Fantasmal"],
		formeOrder: ["Accelgor", "Accelgor-Fantasmal"],
	},
	accelgorhf: {
		num: 617,
		name: "Accelgor-Fantasmal",
  ...
  bisharpdb: {
	...
	dragalge: {
		...
		evoLevel: 48,
		eggGroups: ["Water 1", "Dragon"],
		otherFormes: ["Dragalge-Fantasmal"],
		formeOrder: ["Dragalge", "Dragalge-Fantasmal"],
	},
	dragalgehf: {
		num: 691,
		name: "Dragalge-Fantasmal",
	...
	goodra: {
		...
		evoLevel: 50,
		eggGroups: ["Dragon"],
		otherFormes: ["Goodra-Delta", "Goodra-Elite", "Goodra-Fantasmal"],
		formeOrder: ["Goodra", "Goodra-Delta", "Goodra-Elite", "Goodra-Fantasmal"],
	},
	goodradelta: {
		num: 706,
		name: "Goodra-Delta",
	...
	trevenant: {
		...
		evoType: "trade",
		eggGroups: ["Grass", "Amorphous"],
		otherFormes: ["Trevenant-Delta", "Trevenant-Fantasmal"],
		formeOrder: ["Trevenant", "Trevenant-Delta", "Trevenant-Fantasmal"],
	},
	trevenantdelta: {
		num: 709,
	...
	glaliehf: {
		...
		formeOrder: ["Glalie-Fantasmal", "GlalieHF-Mega"],
	},
	glaliehfmega: {
		num: 899,
		name: "Glalie-HF-Mega",
		baseSpecies: "Glalie-Fantasmal",
		forme: "HF-Mega",
		types: ["Fire", "Rock"],
		...
		battleOnly: "Glalie-Fantasmal",
	},
	altariahf: {
		num: 900,
		name: "Altaria-Fantasmal",
		forme: "Fantasmal",
		types: ["Dragon", "Electric"],
		baseStats: {hp: 75, atk: 70, def: 90, spa: 70, spd: 105, spe: 80},
		abilities: {0: "Lightning Rod"},
		...
		formeOrder: ["Altaria-Fantasmal", "Altaria-HF-Mega"],
	},
	altariahfmega: {
		num: 900,
		name: "Altaria-HF-Mega",
		baseSpecies: "Altaria-Fantasmal",
		forme: "HF-Mega",
		types: ["Dragon", "Electric"],
		baseStats: {hp: 75, atk: 110, def: 110, spa: 110, spd: 105, spe: 80},
		abilities: {0: "Drizzle"},
		...
		battleOnly: "Altaria-Fantasmal",
	},
	sharpedohf: {
		num: 901,
		name: "Sharpedo-Fantasmal",
		types: ["Water", "Ground"],
		...
		formeOrder: ["Sharpedo-Fantasmal", "Sharpedo-HF-Mega"],
	},
	sharpedohfmega: {
		num: 901,
		name: "Sharpedo-HF-Mega",
		baseSpecies: "Sharpedo-Fantasmal",
		forme: "Mega",
		types: ["Water", "Ground"],
		...
		battleOnly: "Sharpedo-Fantasmal",
	},
	sceptilehf: {
		num: 254,
		name: "Sceptile-Fantasmal",
		baseSpecies: "Sceptile",
		types: ["Ghost", "Ground"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 85, def: 65, spa: 105, spd: 85, spe: 120},
		...
		formeOrder: ["Sceptile-Fantasmal", "Sceptile-HF-Mega"],
	},
	sceptilehfmega: {
		num: 254,
		name: "Sceptile-HF-Mega",
		baseSpecies: "Sceptile-Fantasmal",
		forme: "Mega",
		types: ["Ghost", "Ground"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 110, def: 75, spa: 145, spd: 85, spe: 145},
