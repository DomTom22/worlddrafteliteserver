...
venusaurmegax: {
	...
	blastoisemegax: {
		...
		types: ["Water", "Steel"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 79, atk: 125, def: 140, spa: 83, spd: 130, spe: 73},
    ...
    evoLevel: 52,
    eggGroups: ["Human-Like"],
    otherFormes: ["Bisharp-Armira"],
    formeOrder: ["Bisharp", "Bisharp-Armira"],
  },
  bisharpdb: {
    num: 625,
    name: "Bisharp-Armira",
