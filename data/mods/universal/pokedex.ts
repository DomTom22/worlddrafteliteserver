export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	bisharp: {
		...
		evoLevel: 52,
		eggGroups: ["Human-Like"],
		otherFormes: ["Bisharp-Mega", "Bisharp-Armira", "Bisharp-Delta", "Bisharp-Delta-Mega"],
		formeOrder: ["Bisharp", "Bisharp-Armira", "Bisharp-Mega", "Bisharp-Delta", "Bisharp-Delta-Mega"]
	},
	bisharpmega: {
		num: 625,
		name: "Bisharp-Mega",
  ...
  bisharpdb: {
	...
	greninja: {
		...
		evoLevel: 36,
		eggGroups: ["Water 1"],
		otherFormes: ["Greninja-Ash", "Greninja-Armira", "Greninja-Delta"],
		// non-activated Greninja-Ash is forme 1, but PS does not currently distinguish it
		formeOrder: ["Greninja", "Greninja", "Greninja-Ash", "Greninja-Armira", "Greninja-Delta"],
	},
	greninjaash: {
		num: 658,
		name: "Greninja-Ash",
